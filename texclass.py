...
class Book():
    def __init__(self, filename, nochapters, stats):
        ...
        self.ignoreTOC()
        print('Heading locations: %s' % self.headingLocations)
        headingsPlain = [self.lines[loc] for loc in self.headingLocations]
        print('Headings: %s' % headingsPlain)
    ...
    def writeChapters(self):
        ...
        print('Writing chapter headings: %s' % chapterNums)
...
class TexProp:
    ...
    def __init__(self, textname, wordcount, linecount, paragraphcount, chaptercount):
        ...
        self._chaptercount = chaptercount
